            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <?php
                        ...
                        $totalPercentage = $east + $west + $north;
                        $eastPercentage = ($east / $totalPercentage) * 100;
                        $westPercentage = ($west / $totalPercentage) * 100;
                        $northPercentage = ($north / $totalPercentage) * 100;
                        $dataPoints = array( 
                            array("label"=>"Sky-East", "y"=>$eastPercentage),
                            array("label"=>"Sky-North", "y"=>$northPercentage),
                            array("label"=>"Sky-West", "y"=>$westPercentage),
                        );
