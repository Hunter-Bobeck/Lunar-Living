            ...
            <div class="row">
                ...
                <div class="container">
                        ...
                        <ul style = "list-style-type: none;margin: 0;padding: 0;overflow: hidden;background-color: #333;align-text:center">
                            ...
                            <li style="float:left;display: block;color: white;text-align: center;padding: 20px 16px;text-decoration: none"><input placeholder = "ID" type = "text" id = "ticket-search-title" name = "ticketsearchtitle"></li>
